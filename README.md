...
The IPC interface is enabled by default and exposes all the APIs supported by Gseke, whereas the HTTP
...
The go-sekeereum library (i.e. all code outside of the `cmd` directory) is licensed under the
