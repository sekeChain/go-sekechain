...
// Package bind generates sekechain contract Go bindings.
//
// Detailed usage document and tutorial available on the go-sekeereum Wiki page:
// https://github.com/sekechain/go-sekechain/wiki/Native-DApps:-Go-bindings-to-sekechain-contracts
package bind
...
// structured checks whsekeer a list of ABI data types has enough information to
