...
// See https://github.com/sekeereum/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
type KeyStore struct {
	...
	updating    bool                    // Whsekeer the event notification loop is running
...
// HasAddress reports whsekeer a key with the given address is present.
...
// ImportPreSaleKey decrypts the given sekechain presale wallet and stores
