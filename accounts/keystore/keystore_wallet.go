...
// Status implements accounts.Wallet, returning whsekeer the account held by the
...
func (w *keystoreWallet) SelfDerive(base accounts.DerivationPath, chain sekeereum.ChainStateReader) {}
