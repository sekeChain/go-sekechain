...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/sekeereum/pysekesaletool

		pysekesaletool generates the encryption key from password by
	...
	*/
	...
	sekePriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(sekePriv)
	...
	expectedAddr := preSaleKeyStruct.sekeAddr
