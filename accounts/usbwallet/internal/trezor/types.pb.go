...
It has these top-level messages:
	...
	sekechainTxRequest
	sekechainTxAck
	sekechainSignMessage
	sekechainVerifyMessage
	sekechainMessageSignature
	SignIdentity
	SignedIdentity
	GetECDHSessionKey
	ECDHSessionKey
...
func (m *HDNodeType) String() string            { return proto.CompactTexsekering(m) }
...
func (m *HDNodePathType) String() string            { return proto.CompactTexsekering(m) }
...
func (m *CoinType) String() string            { return proto.CompactTexsekering(m) }
...
func (m *MultisigRedeemScriptType) String() string            { return proto.CompactTexsekering(m) }
...
func (m *TxInputType) String() string            { return proto.CompactTexsekering(m) }
...
func (m *TxOutputType) String() string            { return proto.CompactTexsekering(m) }
...
func (m *TxOutputBinType) String() string            { return proto.CompactTexsekering(m) }
...
func (m *TransactionType) String() string            { return proto.CompactTexsekering(m) }
...
func (m *TxRequestDetailsType) String() string            { return proto.CompactTexsekering(m) }
...
func (m *TxRequestSerializedType) String() string            { return proto.CompactTexsekering(m) }
...
func (m *IdentityType) String() string            { return proto.CompactTexsekering(m) }
