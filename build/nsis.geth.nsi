...
# 1. install gseke for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gseke
# 5. create gseke, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable sekeEREUM_SOCKET
...
!define GROUPNAME "sekechain"
!define APPNAME "Gseke"
!define DESCRIPTION "Official Go implementation of the sekechain protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gseke is installed global
