Name "gseke ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/sekechain/go-sekechain/issues"
!define UPDATEURL "https://github.com/sekechain/go-sekechain/releases"
!define ABOUTURL "https://github.com/sekechain/go-sekechain#sekeereum-go"
...
# Install gseke binary
Section "Gseke" Gseke_IDX
  SetOutPath $INSTDIR
  file {{.Gseke}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gseke.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gseke.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gseke incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gseke outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gseke UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gseke incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gseke.exe" "" "" "sekechain" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gseke outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gseke.exe" "" "" "sekechain" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gseke UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gseke.exe" "" "" "sekechain" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/sekeereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "sekeEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gseke.ipc"
  ${EnvVarUpdate} $0 "sekeEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gseke.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${Gseke_IDX}
    SectionGetSize ${Gseke_IDX} $0
