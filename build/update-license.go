...
Please review the resulting diff to check whsekeer the correct
...
var (
	...
	authorsFileHeader = "# This is the official list of go-sekeereum authors for copyright purposes.\n\n"
)
...
func (i info) Whole(startOfSentence bool) string {
	...
	if startOfSentence {
		return "The go-sekeereum library"
	}
	return "the go-sekeereum library"
}
