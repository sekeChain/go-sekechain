...
// This is a simple Whisper node. It could be used as a stand-alone boosekerap node.
...
import (
	...
	"github.com/sekechain/go-sekechain/whisper/mailserver"
	whisper "github.com/sekechain/go-sekechain/whisper/whisperv6"
...
// cmd arguments
var (
	boosekerapMode  = flag.Bool("standalone", false, "boostrap node: don't initiate connection to peers, just wait for incoming connections")
	...
	requestMail    = flag.Bool("mailclient", false, "request expired messages from the boosekerap server")
	...
	argEnode   = flag.String("boot", "", "boosekerap node you want to connect to (e.g. enode://e454......08d50@52.176.211.200:16428)")
...
func startServer() error {
	...
	if *boosekerapMode {
		configureNode()
		fmt.Println("Boosekerap Whisper node started")
	} else {
