...
func (h *Hash) Sesekering(s string) { h.SetBytes([]byte(s)) }
...
// Address represents the 20 byte address of an sekechain account.
...
// IsHexAddress verifies whsekeer a string can represent a valid hex-encoded
// sekechain address or not.
...
func (a *Address) Sesekering(s string) { a.SetBytes([]byte(s)) }
