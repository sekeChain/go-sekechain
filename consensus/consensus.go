...
// Package consensus implements different sekechain consensus engines.
package consensus
...
type Engine interface {
	// Author retrieves the sekechain address of the account that minted the given
	// block, which may be different from the header's coinbase if a consensus
	// engine is based on signatures.
	Author(header *types.Header) (common.Address, error)

	// VerifyHeader checks whsekeer a header conforms to the consensus rules of a
	...
	// VerifySeal checks whsekeer the crypto seal on a header is valid according to
