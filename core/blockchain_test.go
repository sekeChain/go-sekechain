...
func TestFastVsFullChains(t *testing.T) {
	...
	archiveDb, _ := sekedb.NewMemDatabase()
	...
	fastDb, _ := sekedb.NewMemDatabase()
...
func TestLightVsFastVsFullChainHeads(t *testing.T) {
	...
	lightDb, _ := sekedb.NewMemDatabase()
...
//
// https://github.com/sekechain/go-sekechain/pull/15941
