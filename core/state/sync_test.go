...
// makeTessekeate create a sample test state to test node-wise reconstruction.
func makeTessekeate() (Database, common.Hash, []*testAccount) {
...
// account array.
func checkStateAccounts(t *testing.T, db sekedb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db sekedb.Database, root common.Hash) error {
...
func checkStateConsistency(db sekedb.Database, root common.Hash) error {
...
func testIterativeStateSync(t *testing.T, batch int) {
	...
	srcDb, srcRoot, srcAccounts := makeTessekeate()

	// Create a destination state and sync with the scheduler
	dstDb, _ := sekedb.NewMemDatabase()
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(sekedb.Database), srcRoot)
