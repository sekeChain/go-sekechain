...
type Context struct {
	// CanTransfer returns whsekeer the account contains
	// sufficient sekeer to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers sekeer from one account to the other
...
// EVM is the sekechain Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) sekeereum virtual machine
...
func (evm *EVM) Create(caller ContractRef, code []byte, gas uint64, value *big.Int) (ret []byte, contractAddr common.Address, leftOverGas uint64, err error) {
	...
	// check whsekeer the max code size has been exceeded
