...
type StateDB interface {
	...
	Gesekeate(common.Address, common.Hash) common.Hash
	Sesekeate(common.Address, common.Hash, common.Hash)

	Suicide(common.Address) bool
	HasSuicided(common.Address) bool

	// Exist reports whsekeer the given account exists in state.
	// Notably this should also return true for suicided accounts.
	Exist(common.Address) bool
	// Empty returns whsekeer the given account is empty. Empty
