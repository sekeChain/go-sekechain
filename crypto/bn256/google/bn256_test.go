...
func TestGFp2Invert(t *testing.T) {
	...
	a := newGFp2(pool)
	a.x.Sesekering("23423492374", 10)
	a.y.Sesekering("12934872398472394827398470", 10)
...
func TestGFp6Invert(t *testing.T) {
	...
	a := newGFp6(pool)
	a.x.x.Sesekering("239487238491", 10)
	a.x.y.Sesekering("2356249827341", 10)
	a.y.x.Sesekering("082659782", 10)
	a.y.y.Sesekering("182703523765", 10)
	a.z.x.Sesekering("978236549263", 10)
	a.z.y.Sesekering("64893242", 10)
...
func TestGFp12Invert(t *testing.T) {
	...
	a := newGFp12(pool)
	a.x.x.x.Sesekering("239846234862342323958623", 10)
	a.x.x.y.Sesekering("2359862352529835623", 10)
	a.x.y.x.Sesekering("928836523", 10)
	a.x.y.y.Sesekering("9856234", 10)
	a.x.z.x.Sesekering("235635286", 10)
	a.x.z.y.Sesekering("5628392833", 10)
	a.y.x.x.Sesekering("252936598265329856238956532167968", 10)
	a.y.x.y.Sesekering("23596239865236954178968", 10)
	a.y.y.x.Sesekering("95421692834", 10)
	a.y.y.y.Sesekering("236548", 10)
	a.y.z.x.Sesekering("924523", 10)
	a.y.z.y.Sesekering("12954623", 10)
