...
func NewLesOdr(db sekedb.Database, chtIndexer, bloomTrieIndexer, bloomIndexer *core.ChainIndexer, retriever *retrieveManager) *LesOdr {
	return &LesOdr{
		db:               db,
...
func (odr *LesOdr) Database() sekedb.Database {
	return odr.db
}
