...
func makeHeaderChain(parent *types.Header, n int, db sekedb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (sekedb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() sekedb.Database {
	return odr.db
}
