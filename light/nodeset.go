...
func (db *NodeSet) Store(target sekedb.Putter) {
	db.lock.RLock()
	defer db.lock.RUnlock()
...
// NodeList stores an ordered list of trie nodes. It implements sekedb.Putter.
type NodeList []rlp.RawValue

// Store writes the contents of the list to the given database
func (n NodeList) Store(db sekedb.Putter) {
	for _, node := range n {
