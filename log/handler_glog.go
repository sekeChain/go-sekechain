...
type GlogHandler struct {
	...
	override  uint32 // Flag whsekeer overrides are used, atomically accessible
	backtrace uint32 // Flag whsekeer backtrace location is set
...
func (h *GlogHandler) Log(r *Record) error {
	// If backtracing is requested, check whsekeer this is the callsite
