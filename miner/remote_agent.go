...
type RemoteAgent struct {
	...
	running int32 // running indicates whsekeer the agent is active. Call atomically
}
...
// whsekeer the solution was accepted or not (not can be both a bad pow as well as
