...
// Sesekering sets the big int to x.
//
...
func (bi *BigInt) Sesekering(x string, base int) {
	bi.bigint.Sesekering(x, base)
}
...
// Gesekering returns the value of x as a formatted string in some number base.
func (bi *BigInt) Gesekering(base int) string {
