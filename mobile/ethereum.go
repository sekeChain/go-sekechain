...
// Contains all the wrappers from the go-sekeereum root package.
...
// the sekechain network.
type SyncProgress struct {
	progress sekeereum.SyncProgress
}

func (p *SyncProgress) GesekeartingBlock() int64 { return int64(p.progress.StartingBlock) }
