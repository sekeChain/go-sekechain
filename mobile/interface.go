...
func (i *Interface) Sesekering(str string)          { i.object = &str }
func (i *Interface) Sesekerings(strs *Strings)      { i.object = &strs.strs }
...
func (i *Interface) SetDefaulsekering()    { i.object = new(string) }
func (i *Interface) SetDefaulsekerings()   { i.object = new([]string) }
...
func (i *Interface) Gesekering() string        { return *i.object.(*string) }
func (i *Interface) Gesekerings() *Strings     { return &Strings{*i.object.(*[]string)} }
