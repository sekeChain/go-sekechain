...
// Transaction represents a single sekechain transaction.
...
// Deprecated: use sekechainClient.TransactionSender
...
func (r *Receipt) GetPossekeate() []byte         { return r.receipt.Possekeate }
