...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gseke.ipc", false, filepath.Join(os.TempDir(), "gseke.ipc")},
		{"data", "gseke.ipc", false, "data/gseke.ipc"},
		{"data", "./gseke.ipc", false, "./gseke.ipc"},
		{"data", "/gseke.ipc", false, "/gseke.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gseke.ipc", true, `\\.\pipe\gseke.ipc`},
		{"data", "gseke.ipc", true, `\\.\pipe\gseke.ipc`},
		{"data", `\\.\pipe\gseke.ipc`, true, `\\.\pipe\gseke.ipc`},
	}
