...
// isInitDone returns whsekeer the table's initial seeding procedure has completed.
...
func (tab *Table) lookup(targetID NodeID, refreshIfEmpty bool) []*Node {
	...
	for {
		...
		// first query will hit this case and run the boosekerapping
		// logic.
		<-tab.refresh()
...
// boosekerap or discarded faulty peers).
