...
// Contains reports whsekeer the given IP is contained in the list.
...
// IsLAN reports whsekeer an IP is a local network address.
...
// IsSpecialNetwork reports whsekeer an IP is located in a special-use network range
...
// CheckRelayIP reports whsekeer an IP relayed from the given sender IP
...
// SameNet reports whsekeer two IP addresses have an equal prefix of the given bit length.
...
// Contains whsekeer the given IP is contained in the set.
