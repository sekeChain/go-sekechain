...
import (
	...
	"github.com/sekechain/go-sekechain/crypto/ecies"
	"github.com/sekechain/go-sekechain/crypto/secp256k1"
...
// and also verifies whsekeer the encryption handshake 'worked' and the
...
type authMsgV4 struct {
	gotPlain bool // whsekeer read packet had plain format.
