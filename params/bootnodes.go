...
// MainnetBootnodes are the enode URLs of the P2P boosekerap nodes running on
// the main sekechain network.
var MainnetBootnodes = []string{
	// sekechain Foundation Go Bootnodes
...
// TestnetBootnodes are the enode URLs of the P2P boosekerap nodes running on the
// Ropsten test network.
var TestnetBootnodes = []string{
}

// RinkebyBootnodes are the enode URLs of the P2P boosekerap nodes running on the
// Rinkeby test network.
var RinkebyBootnodes = []string{
}

// DiscoveryV5Bootnodes are the enode URLs of the P2P boosekerap nodes for the
