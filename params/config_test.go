...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllsekeashProtocolChanges, new: AllsekeashProtocolChanges, head: 0, wantErr: nil},
		{stored: AllsekeashProtocolChanges, new: AllsekeashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: AllsekeashProtocolChanges,
