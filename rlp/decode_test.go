...
func TessekereamKind(t *testing.T) {
	tests := []struct {
		input    string
		wantKind Kind
		wantLen  uint64
...
func TestNewLissekeream(t *testing.T) {
	ls := NewLissekeream(bytes.NewReader(unhex("0101010101")), 3)
...
func TessekereamErrors(t *testing.T) {
...
func TessekereamList(t *testing.T) {
...
func TessekereamRaw(t *testing.T) {
	tests := []struct {
		input  string
		output string
	}{
