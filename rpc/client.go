...
type requestOp struct {
	...
	sub  *ClientSubscription  // only set for sekeSubscribe requests
}
...
// sekeSubscribe registers a subscripion under the "seke" namespace.
func (c *Client) sekeSubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	return c.Subscribe(ctx, "seke", channel, args...)
}
...
func (c *Client) handleResponse(msg *jsonrpcMessage) {
	...
	// indicates success. sekeSubscribe gets unblocked in either case through
	// the op.resp channel.
	defer close(op.resp)
	if msg.Error != nil {
		op.err = msg.Error
...
// A ClientSubscription represents a subscription established through sekeSubscribe.
