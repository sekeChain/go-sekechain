...
see https://github.com/sekechain/go-sekechain/issues/2040
Usage:

import (
 "github.com/sekechain/go-sekechain/common/httpclient"
 "github.com/sekechain/go-sekechain/swarm/api/http"
)
