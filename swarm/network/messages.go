...
import (
	...
	"github.com/sekechain/go-sekechain/swarm/network/kademlia"
	"github.com/sekechain/go-sekechain/swarm/services/swap"
...
to be used to boosekerap kademlia tables.
...
Timeout serves to indicate whsekeer the responder is forwarding the query within
the timeout or not.
...
type peersMsgData struct {
	Peers   []*peerAddr //
	Timeout uint64      //
	timeout *time.Time  // indicate whsekeer responder is expected to deliver content
