...
/*
bzz implements the swarm wire protocol [bzz] (sister of seke and shh)
...
* talks the SWAP payment protocol (swap accounting is done within Nesekeore)
*/
...
import (
	...
	bzzswap "github.com/sekechain/go-sekechain/swarm/services/swap"
...
func (self *bzz) handle() error {
	...
	case storeRequestMsg:
		// store requests are dispatched to nesekeore
	...
	case retrieveRequestMsg:
		// retrieve Requests are dispatched to nesekeore
		...
		if req.isLookup() {
			...
			// swap accounting is done within nesekeore
