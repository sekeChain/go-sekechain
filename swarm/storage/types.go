...
import (
	...
	"github.com/sekechain/go-sekechain/bmt"
...
func newRequessekeatus(key Key) *Requessekeatus {
	return &Requessekeatus{
		Key:        key,
...
- Nesekeore: cloud storage abstraction layer
