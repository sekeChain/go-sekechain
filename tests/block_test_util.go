...
// Package tests implements execution of sekechain JSON tests.
package tests
...
type btJSON struct {
	...
	Post      core.GenesisAlloc     `json:"possekeate"`
...
func (t *BlockTest) Run() error {
	...
	if err = t.validatePossekeate(newDB); err != nil {
...
/* See https://github.com/sekeereum/tests/wiki/Blockchain-Tests-II

   Whsekeer a block is valid or not is a bit subtle, it's defined by presence of
...
func (t *BlockTest) validatePossekeate(statedb *state.StateDB) error {
