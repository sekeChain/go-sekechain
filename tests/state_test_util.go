...
// See https://github.com/sekeereum/EIPs/issues/176 for the test format specification.
...
type stJSON struct {
	...
	Post map[string][]stPossekeate `json:"post"`
}

type stPossekeate struct {
...
func MakePreState(db sekedb.Database, accounts core.GenesisAlloc) *state.StateDB {
...
func (tx *stTransaction) toMessage(ps stPossekeate) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/sekeereum/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
