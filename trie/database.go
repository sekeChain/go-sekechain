...
type DatabaseReader interface {
	...
	// Has retrieves whsekeer a key is present in the database.
...
type Database struct {
	diskdb sekedb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb sekedb.Database) *Database {
	return &Database{
		diskdb: diskdb,
...
func (db *Database) commit(hash common.Hash, batch sekedb.Batch) error {
	// If the node does not exist, it's a previously committed node
