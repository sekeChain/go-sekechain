...
// Syncing provides information when this nodes starts synchronising with the sekechain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  sekeereum.SyncProgress `json:"status"`
}
