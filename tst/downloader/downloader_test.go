...
type downloadTester struct {
	...
	stateDb sekedb.Database // Database used by the tester for syncing from peers
	peerDb  sekedb.Database // Database of the peers containing all data
...
func newTester() *downloadTester {
	testdb, _ := sekedb.NewMemDatabase()
	...
	tester.stateDb, _ = sekedb.NewMemDatabase()
