...
// PeerInfo represents a short summary of the sekechain sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // sekechain protocol version negotiated
...
// Handshake executes the seke protocol handshake, negotiating version number,
...
func (p *peer) String() string {
	return fmt.Sprintf("Peer %s [%s]", p.id,
		fmt.Sprintf("seke/%2d", p.version),
	)
}

// peerSet represents the collection of active peers currently participating in
// the sekechain sub-protocol.
type peerSet struct {
