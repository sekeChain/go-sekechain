...
var ProtocolName = "seke"

// Supported versions of the seke protocol (first is primary).
var ProtocolVersions = []uint{seke63, seke62}
...
// seke protocol message codes
const (
	// Protocol messages belonging to seke/62
	StatusMsg          = 0x00
	...
	// Protocol messages belonging to seke/63
	GetNodeDataMsg = 0x0d
	NodeDataMsg    = 0x0e
	GetReceiptsMsg = 0x0f
	ReceiptsMsg    = 0x10
