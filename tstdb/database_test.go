...
func newTestLDB() (*sekedb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "sekedb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := sekedb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func testPutGet(db sekedb.Database, t *testing.T) {
	t.Parallel()
...
func testParallelPutGet(db sekedb.Database, t *testing.T) {
	const n = 8
