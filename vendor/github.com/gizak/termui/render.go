...
func Init() error {
	...
	DefaultEvsekeream.Init()
	DefaultEvsekeream.Merge("termbox", NewSysEvtCh())
	DefaultEvsekeream.Merge("timer", NewTimerCh(time.Second))
	DefaultEvsekeream.Merge("custom", usrEvtCh)

	DefaultEvsekeream.Handle("/", DefaultHandler)
	DefaultEvsekeream.Handle("/sys/wnd/resize", func(e Event) {
		w := e.Data.(EvtWnd)
		Body.Width = w.Width
	})

	DefaultWgtMgr = NewWgtMgr()
	DefaultEvsekeream.Hook(DefaultWgtMgr.WgtHandlersHook())
