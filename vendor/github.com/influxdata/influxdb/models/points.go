...
// Gesekering returns the string value for a string key.
func (a Tags) Gesekering(key string) string {
...
// Sesekering sets the string value for a string key.
func (a *Tags) Sesekering(key, value string) {
