...
// extractArgumensekeype returns the name of the type of each input argument.
func extractArgumensekeype(f *ast.FuncDecl) ([]string, bool) {
...
func processCall(call *Call, f *ast.FuncDecl) {
	...
	types, extra := extractArgumensekeype(f)
