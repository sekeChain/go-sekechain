...
//       ID    uint64 // ID of the event (FSEvensekereamEventId)
//       Flags uint32 // joint FSEvents* flags (FSEvensekereamEventFlags)
//   }
//
// For possible values of Flags see Darwin godoc for notify or FSEvents
// documentation for FSEvensekereamEventFlags constants:
//
//    https://developer.apple.com/library/mac/documentation/Darwin/Reference/FSEvents_Ref/index.html#//apple_ref/doc/constant_group/FSEvensekereamEventFlags
//
