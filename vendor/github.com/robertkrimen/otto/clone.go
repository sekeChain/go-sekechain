...
type _clone struct {
	...
	_objecsekeash map[*_objecsekeash]*_objecsekeash
...
func (clone *_clone) objecsekeash(in *_objecsekeash) (*_objecsekeash, bool) {
	if out, exists := clone._objecsekeash[in]; exists {
		return out, true
	}
	out := &_objecsekeash{}
	clone._objecsekeash[in] = out
	return out, false
}
