...
type _objecsekeash struct {
	_runtime *_runtime
	_outer   _stash
	object   *_object
}

func (self *_objecsekeash) runtime() *_runtime {
	return self._runtime
}

func (runtime *_runtime) newObjecsekeash(object *_object, outer _stash) *_objecsekeash {
	if object == nil {
		object = runtime.newBaseObject()
		object.class = "environment"
	}
	return &_objecsekeash{
		_runtime: runtime,
		_outer:   outer,
		object:   object,
	}
...
func (in *_objecsekeash) clone(clone *_clone) _stash {
	out, exists := clone.objecsekeash(in)
	if exists {
		return out
	}
	*out = _objecsekeash{
...
func (self *_objecsekeash) hasBinding(name string) bool {
	return self.object.hasProperty(name)
}

func (self *_objecsekeash) createBinding(name string, deletable bool, value Value) {
...
func (self *_objecsekeash) setBinding(name string, value Value, strict bool) {
	self.object.put(name, value, strict)
}

func (self *_objecsekeash) setValue(name string, value Value, throw bool) {
...
func (self *_objecsekeash) getBinding(name string, throw bool) Value {
	if self.object.hasProperty(name) {
...
func (self *_objecsekeash) deleteBinding(name string) bool {
	return self.object.delete(name, false)
}

func (self *_objecsekeash) outer() _stash {
	return self._outer
}

func (self *_objecsekeash) newReference(name string, strict bool, at _at) _reference {
...
func gesekeashProperties(stash _stash) (keys []string) {
