...
const (
	...
	// Defaulsekerict is the default strict flags. Specify any strict flags
	// will override default strict flags as whole (i.e. not OR'ed).
	Defaulsekerict = StrictJournalChecksum | StrictBlockChecksum | StrictCompaction | StrictReader
...
func (o *Options) Gesekerict(strict Strict) bool {
	if o == nil || o.Strict == 0 {
		return Defaulsekerict&strict != 0
	}
...
func (ro *ReadOptions) Gesekerict(strict Strict) bool {
	if ro == nil {
		return false
	}
...
func Gesekerict(o *Options, ro *ReadOptions, strict Strict) bool {
	if ro.Gesekerict(StrictOverride) {
		return ro.Gesekerict(strict)
	} else {
		return o.Gesekerict(strict) || ro.Gesekerict(strict)
	}
}
