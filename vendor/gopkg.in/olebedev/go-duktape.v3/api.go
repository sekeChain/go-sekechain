...
func (d *Context) Gesekering(i int) string {
...
func (d *Context) Pcompile(flags uint) error {
	...
	return d.cassekeringToError(result)
}
...
func (d *Context) PcompileString(flags uint, src string) error {
	...
	return nil //d.cassekeringToError(result)
}
...
func (d *Context) cassekeringToError(result int) error {
	if result == 0 {
		return nil
	}
