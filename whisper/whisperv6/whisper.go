...
// Whisper represents a dark communication interface through the sekechain
...
// New creates a Whisper client ready to communicate through the sekechain P2P network.
...
// param isP2P indicates whsekeer the message is peer-to-peer (should not be forwarded).
